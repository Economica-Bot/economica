...
const TOS: NextPageWithLayout = () => (
	<div className="flex justify-center">
		<article className="prose lg:prose-lg mt-40 mb-5 p-3">
          ...
          website (the &quot;Service&quot;) operated by Economica
          (&quot;us&quot;, &quot;we&quot;, or &quot;our&quot;).
			</p>
			<p>
          ...
          that are not owned or controlled by Economica.
			</p>
			<p>
          ...
          course of performance.
			...
			<p>
          Economica its subsidiaries, affiliates, and its licensors do not
          ...
          on our <Link href="localhost:3001/api/support">support server</Link>.
			</p>
		</article>
	</div>
);

TOS.getLayout = (page) => <BaseLayout>{page}</BaseLayout>;
