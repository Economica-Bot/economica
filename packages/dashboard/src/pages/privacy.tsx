...
const PrivacyPage: NextPageWithLayout = () => (
	<div className="flex justify-center">
		<article className="prose lg:prose-lg mt-40 mb-5 p-3">
			...
			<p>
          Economica (&quot;us&quot;, &quot;we&quot;, or &quot;our&quot;)
          operates the https://www.economicabot.com website (hereinafter
          ...
          https://www.economicabot.com
			...
			<ul>
				<li>
					<h3>Service</h3>
					<p>
              Service is the https://www.economicabot.com website operated by
              Economica
					</p>
				</li>
				<li>
          ...
          you may not be able to use some portions of our Service.
			...
			<h2>Use of Data</h2>
			<p>Economica uses the collected data for various purposes:</p>
			<ul>
          ...
          Protection Regulation (GDPR)
			...
			<p>
          If you are from the European Economic Area (EEA), Economica legal
          ...
          specific context in which we collect it.
			...
			<p>Economica may process your Personal Data because:</p>
			<ul>
			...
			<p>
          Economica will retain your Personal Data only for as long as is
          ...
          including the security of your data and other personal information.
			...
			<p>
          Economica may disclose your Personal Data in the good faith belief
          that such action is necessary to:
			</p>
			<ul>
				<li>To comply with a legal obligation</li>
				<li>To protect and defend the rights or property of Economica</li>
				<li>
          ...
          certain data protection rights. Melms Media LLC aims to take
          ...
          rights:
			...
			<ul>
              ...
              structured, machine-readable and commonly used format.
				...
				<li>
					<p>
						<strong>The right to data portability.</strong> You also have the
              right to withdraw your consent at any time where Melms Media LLC
...
PrivacyPage.getLayout = (page) => <BaseLayout>{page}</BaseLayout>;
