import { EmbedBuilder, GuildApplicationCommandPermissionData, ApplicationCommandPermissionType, Util, Embed } from 'discord.js';
...
export default class implements Command {
	...
	public execute = async (ctx: Context): Promise<void> => {
		...
		if (subcommand === 'view') {
			...
			const authorityLevel = Authorities[ctx.interaction.options.getString('authority')];
			...
			const fullPermissions = (await ctx.client.application.commands.fetch())
