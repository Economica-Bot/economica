const globalCreateOptions = {
  ...
  ***REMOVED***
    {
      name: 'required_roles',
      description: 'Roles that a user must have to purchase.',
      type: apiTypes.Role,
      required: false,
  ***REMOVED***
    {
      ...
      options: [
        {
          name: 'role',
          description:
            'Create a new shop item that gives and/or removes roles.',
          ...
          ***REMOVED***
            {
              ...
              description:
                'The amount of time until the given role will be removed. Never by default.',
              type: apiTypes.String,
              required: false,
          ***REMOVED***
