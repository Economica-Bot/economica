        ...
        if (!options.compilerHost) {
            ...
            const host = ts.createIncrementalCompilerHost
                ...
                : Object.assign(Object.assign({}, sys), { getSourceFile: (fileName, languageVersion) => {
                  ...
                  ***REMOVED*** getDefaultLibLocation: () => (0, util_1.normalizeSlashes)((0, path_1.dirname)(compiler)), getDefaultLibFileName: () => (0, util_1.normalizeSlashes)((0, path_1.join)((0, path_1.dirname)(compiler), ts.getDefaultLibFileName(config.options))), useCaseSensitiveFileNames: () => sys.useCaseSensitiveFileNames });
            ...
            getOutput = (code, fileName) => {
              ...
              ***REMOVED*** undefined, undefined, customTransformers);
